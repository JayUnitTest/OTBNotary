...
Documents.prototype.init = function() {
    ...
    if (typeof window.ethereum !== 'undefined') {
        ...
        var contractAddress = '0x629097820d190DDedC00a883a43ac0083F3346A4';

        ethereum.enable().then(function(accounts) {
            // Create the contract instance for the specific address provided in the configuration
            that.instance = new that.web3.eth.Contract([{
                "constant": true,
                "inputs": [{
...
// stores value on instance of contract and updates the UI
...
// sends the hash of a document on the instance of the contract
    ...
    this.getDocument(hash, function(error, result) {
        ...
        that.web3.eth.getGasPrice(function(error, gasPrice) {
            ...
            that.web3.eth.getAccounts(function(error, accounts) {
                ...
                that.instance.methods.addDocument(hash).estimateGas({
                        from: accounts[0]
                    },
